...
class ReviewServiceImplTest {
    ...
    @MockBean
    private PMColleagueCycleDAO mockColleagueCycleDAO;
    ...
    void getReviewByUuidShouldReturnReview() {
        ...
        final var expectedTimelinePoint = TimelinePoint.builder().build();

        when(mockColleagueCycleDAO.getByParams(any(), any(), any()))
