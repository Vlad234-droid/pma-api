...
public interface PDPService {
     ...
     */
    List<PDPGoal> createPDP(@NotNull UUID colleagueUuid, @NotEmpty List<PDPGoal> goals);

    /**
     * Add a PDP Goal to a Plan
     *
     * @param colleagueUuid is colleague identifier
     * @param goal          is PDP goal
     * @return added PDP goal
     */
    PDPGoal addPDPGoal(@NotNull UUID colleagueUuid, @NotNull PDPGoal goal);
     ...
     */
    List<PDPGoal> updatePDP(@NotNull UUID colleagueUuid, @NotEmpty List<PDPGoal> goals);
     ...
     */
    void deletePDPGoalByColleagueAndNumber(@NotNull UUID colleagueUuid, @NotNull Integer number);
     ...
     */
    void deletePDPGoalByUuid(@NotNull UUID goalUuid);
     ...
     */
    PDPGoal getPDPGoalByColleagueAndNumber(@NotNull UUID colleagueUuid, @NotNull Integer number);
     ...
     */
    PDPGoal getPDPGoalByUuid(@NotNull UUID goalUuid);
     ...
     */
    List<PDPGoal> getPDPGoalsByColleague(@NotNull UUID colleagueUuid);
}